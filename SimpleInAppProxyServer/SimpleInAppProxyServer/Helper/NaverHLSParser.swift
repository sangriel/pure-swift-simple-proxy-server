...
//Connection: keep-alive
class NaverHLSParser : HLSParser {
    
    //https://livecloud.pstatic.net/selective/lip2_kr/anmss1226/6frpwuipzbjzpwwrc5kboysyrdnzexxb8sj5/
     var originUrlHost : String
     var originUrlQueryKey : String
    
     var tsFileBaseQuerySet: Set<String> = []
    ...
    required init(originUrlHost : String, originUrlQueryKey : String){
